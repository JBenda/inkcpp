 ...
 * and cann be reconsrtucted with the id parameter of @ref ink::runtime::story::new_runner_from_snapshot()
 *
...
public:
	...
	/** Construct snapshot from blob.
		...
		* @param freeOnDestroy if the memory should be freed (delete[]) when the snapshot is deconstructed
