...
public:
	...
	void operator()(Command, basic_eval_stack&) { inkFail("requested command was not found!"); }
};
...
public:
	 ...
	 */
	void operator()(Command cmd, basic_eval_stack& stack) { _executer(cmd, stack); }
